...
class GlobalConfig(BaseSettings):
    ...
    TOKENIZER_LOCAL_PATH: str = os.path.join(MODEL_PATH, "tokenizer.bin")
    EMBEDDER_LOCAL_PATH: str = os.path.join(MODEL_PATH, "embedder.bin")
    W2V_LOCAL_PATH: str = os.path.join(MODEL_PATH, "w2v.bin")
    BPEMB_VS: int = 200000
    BPEM_DIM: int = 300
